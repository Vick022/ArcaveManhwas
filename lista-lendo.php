...
<link rel="stylesheet" href="css\lista-lendo.css">
<div class="container-h1">
    <h1>Manhwas que você está lendo</h1>
</div>
  ...
  <div class="content">    
        <?php
         ...
         if (isset($_GET["idManhwa"]) && isset($_GET["capPause"])) {
          ...
          $sql = "UPDATE tblendo SET capPause = $capPause WHERE idManhwa = $idManhwa";
...
echo "<p> $msg   </p>";
          ...
          $sql = "SELECT * FROM
          tblendo as l inner join 
          tbmanhwas as m on l.idManhwa = m.idManhwa
          where idUser = $idUser 
          order by idLendo desc";
...
<div class="buttons-form">
  <div class="button-class"><a href="?menu=ver&idManhwa=<?= $dados["idManhwa"] ?>"><button class="book-list-item-button">Ver</button></a>
    ...
    <a class="btn btn-outline-danger" href="index.php?menu=excluir-lendo&idLendo=<?= $dados["idLendo"] ?>">
      <i class="ph-duotone ph-trash icone"></i>
    </a>
    <form action="" method="get">
<div class="formulario">
      <div class="form">
        <input type="hidden" name="menu" value="lista-lendo">
