...
<link rel="stylesheet" href="css\lista-lido.css">
<div class="container-h1">

    <h1>Seus  Manhwas  Lidos</h1>
...
echo "<p> $msg   </p>";
          ...
          $sql = "SELECT * FROM
          tblidos as l inner join 
          tbmanhwas as m on l.idManhwa = m.idManhwa
          where idUser = $idUser 
          order by idLidos desc";
    ...
    <span class="book-list-item-title"><?=$dados["nomeManhwa"]?></span>
      <p class="book-list-item-desc"><?=text_limiter_caracter($str, 200, '...')?></p>
         ...
         <a class="btn btn-outline-danger" href="index.php?menu=excluir-lido&idLidos=<?=$dados["idLidos"]?>">
